...
// ============================
// Positions API (in-memory)
// ============================
// chave = CustomerId, valor = lista de posições
...
positions.MapPost("/", (UpsertPositionRequest req) =>
{
    ...
    // remove a anterior do mesmo símbolo (upsert)
